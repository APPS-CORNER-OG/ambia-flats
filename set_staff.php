       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
                ...
                <a href="set_stadd.php"><span style="background-color:#3CC; padding:5px;">Add New</span> </a>
				</h2>
...
<tr> <th>SL</th> <th>Name</th> <th>Mobile</th> <th>Address</th> </tr>
<?php 
	$sql= "Select * from staffs order by full_name ASC";
			$res= mysqli_query($db,$sql);
			while($row=mysqli_fetch_assoc($res)){ $s++;				
			echo "<tr> <td>$s</td> <td>$row[full_name]</td> <td>$row[address]</td> <td>$row[mobile]</td> </tr>";
						  }
