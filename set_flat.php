       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
                ...
                <a href="set_fltadd.php"><span style="background-color:#3CC; padding:5px;">Add New</span> </a>
				</h2>
...
<table id="example" class="table table-striped table-bordered table-hover">
  ...
  <?php 
	$sql= "Select * from flat_info order by flat_no ASC";
			...
			echo "<tr> <td>$s</td> <td>$row[flat_no]</td> <td>$row[owner_name]</td> <td>$row[mobile_no]</td> <td>$row[utility]</td> <td>$row[dish_bill]</td> <td>$row[mosque]</td> <td><a href='set_fltadd.php?fsln=$row[flt_sl]'>edit</a></td> </tr>";
						  }
