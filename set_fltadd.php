       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
				...
				<span><a href="set_flat.php">Flat Information</a></span> 
...
$sql="insert into flat_info(owner_name, mobile_no,	flat_no,	religion, load_, meter_no, dish_bill, utility, mosque)  	 	 	 	 	
values('$_POST[fname]', '$_POST[mobile]', '$_POST[fno]', '$_POST[religion]', '$_POST[load]', '$_POST[metter_no]', '$_POST[dish_bill]', '$_POST[utility]', '$_POST[mosque]')";
$res=mysqli_query($db,$sql);
echo "<strong>Data Save Successful</strong>";
}

if(isset($_POST['editsub'])){	
$sql="update flat_info set owner_name='$_POST[fname]', mobile_no='$_POST[mobile]',	flat_no='$_POST[fno]',	religion='$_POST[religion]', load_='$_POST[load]', meter_no='$_POST[metter_no]', dish_bill='$_POST[dish_bill]', utility='$_POST[mosque]', mosque='$_POST[utility]' where flt_sl='$_GET[fsln]'"; //echo $sql;
$res=mysqli_query($db,$sql);
echo "<strong>Data Edit Successful</strong>";
}

?> 
<?php
	$res= mysqli_query($db,"Select * from flat_info where flt_sl='$_GET[fsln]'"); $row=mysqli_fetch_assoc($res);
            ?>	
<form class="form-horizontal" method="post">
 
	<div class="form-group">
    <label  class="col-sm-2 control-label hor-form">Flat No.</label>
    <div class="col-sm-10">     
		<input type="text" required class="form-control" name="fno" value="<?php echo $row['flat_no']; ?>" placeholder="Flat No">
    </div>
    </div>
  	<div class="form-group">
    <label  class="col-sm-2 control-label hor-form">Owner Name</label>
    <div class="col-sm-10">     
		<input type="text" required class="form-control" name="fname" value="<?php echo $row['owner_name']; ?>" placeholder="Name">
    </div>
    </div>
	<div class="form-group">
    <label class="col-sm-2 control-label hor-form">Mobile Number</label>
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="mobile" value="<?php echo $row['mobile_no']; ?>" placeholder="Mobile Number">
    </div>
  	</div>
    	
  	<div class="form-group">
    <label class="col-sm-2 control-label hor-form">Religion</label>
    <div class="col-sm-10">     
    ...
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Electricity Load</label>
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="load" value="<?php echo $row['load_']; ?>" placeholder="Electricity Load">
    </div>
  	</div>
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Meter No</label>
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="metter_no" value="<?php echo $row['meter_no']; ?>" placeholder="Meter No">
    </div>
  	</div>
    
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Utility</label>
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="utility" value="<?php echo $row['utility']; ?>" placeholder="Utility">
    </div>
  	</div>
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Dish Bill</label>
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="dish_bill" value="<?php echo $row['dish_bill']; ?>" placeholder="Dish Bill">
    </div>
  	</div>
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Mosque</label>
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="mosque" value="<?php echo $row['mosque']; ?>" placeholder="Mosque">
    </div>
  	</div>
 ...
 <?php if($_GET['fsln']==''){?>     <button type="submit" name="submit" class="btn btn-success">Save</button> <?php } ?>
 <?php if($_GET['fsln']!=''){?>       <button type="submit" name="editsub" class="btn btn-default">Edit</button> <?php } ?>
    </div>
  </div>
