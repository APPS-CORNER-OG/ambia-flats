       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
				...
				<span>Electricity Bill Entry</span> 
...
if(isset($_POST['save'])){
	...
	foreach ($_POST['ebill'] as $j => $chkvals) 
            {              
  $sql="update month_bill set elect_bill = '$chkvals' where bl_sl ='$j'";
               // echo $sql."<br />";
                mysqli_query($db,"$sql");				
...
<tr><td><strong>Flat No</strong> </td> <td><strong>Bill</strong> </td></tr>
...
echo "<tr> <td>$mslet[flat_no]</td> <td><input value='$row[elect_bill]' name='ebill[$row[bl_sl]]' /></td> </tr>";
						  }
