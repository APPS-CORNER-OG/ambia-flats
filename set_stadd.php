       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
				...
				<span><a href="set_staff.php">Staff Name</a></span> 
...
$sql="insert into staffs(full_name, address,	mobile,	digination)
values('$_POST[fname]','$_POST[mobile]','$_POST[address]','$_POST[digination]')";
...
<form class="form-horizontal" method="post">
    ...
    <div class="col-sm-10">     
		<input type="text" required class="form-control" name="fname" id="" placeholder="Name">
    </div>
    </div>
    ...
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="mobile" id="" placeholder="Mobile Number">
    </div>
  	</div>
    ...
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Digination</label>
    <div class="col-sm-10">     
		<input type="text" class="form-control" name="digination" id="" placeholder="Digination">
    </div>
  	</div>
