...
<tr> <td align="center">SL</td> <td align="center">Date</td> <td align="center">Name</td> <td align="center">Detail</td> <td align="center">Amount</th> <td align="center">Edit</td> </tr>
<?php  $tot=0;
	$sql= "Select * from expenditure_dtail";  	 	
...
$sq= mysqli_query($db,"Select * from expenditure_head where exp_sl='$row[exp_sl]'"); $exdt=mysqli_fetch_assoc($sq);				
			echo "<tr> <td>$s</td> <td>$row[date_]</td> <td>$exdt[exp_name]</td> <td>$row[detail]</td> <td align='right'>$row[amount_]</td> <td align='center'><a href='ent_expnd.php?sln=$row[exdsl]'>Edit</a> </td></tr>";
			$tot=$tot+$row['amount_'];
						  }
