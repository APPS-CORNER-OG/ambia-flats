...
$sql="insert into expenditure_head (exp_name, mosque) values('$_POST[fname]', '$_POST[mosque]')";
...
<div class="form-group">
    ...
    <div class="col-sm-10">     
        ...
        </select> ( if for Mosque cost select)
    </div>
    </div>
  <div class="form-group">
