       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
				...
				<span>Electric Meter Reading Entry</span> 
...
<tr><td><strong>Flat No</strong> </td> <td><strong>Reading</strong> </td></tr>
...
echo "<tr> <td>$mslet[flat_no]</td> <td><input value='$row[meter_reading]' name='ebill[$row[bl_sl]]' /></td> </tr>";
						  }
