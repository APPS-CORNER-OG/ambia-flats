...
$sql="insert into expenditure_dtail (date_, exp_sl,	detail,	amount_) values('$_POST[date_]', '$_POST[ecpndsl]', '$_POST[detail]', '$_POST[amount]')";
...
$sq= mysqli_query($db,"Select * from expenditure_dtail where exdsl='$_GET[sln]'"); $expdtl=mysqli_fetch_assoc($sq);
?>	
<form class="form-horizontal" method="post">
 <div class="form-group">
	...
	<div class="form-group">
    <label  class="col-sm-2 control-label hor-form">Expenditure Head</label>
    <div class="col-sm-10">     
		<select  name="ecpndsl" required class="form-control">
        	
            <?php
$sqn= mysqli_query($db,"Select * from expenditure_head where exp_sl='$expdtl[exp_sl]'"); $expn=mysqli_fetch_assoc($sqn);
echo "<option value='$expn[exp_sl]'>$expn[exp_name]</option>";
			$sql= "Select * from expenditure_head order by exp_name ASC";
			$res= mysqli_query($db,$sql);
			while($row=mysqli_fetch_assoc($res)){			
			echo "<option value='$row[exp_sl]'>$row[exp_name]</option>";
						  }
						  ?>
    ...
    <div class="form-group">
    <label  class="col-sm-2 control-label hor-form">Detail</label>
    <div class="col-sm-10">     
		<input type="text"  class="form-control" name="detail" value="<?php echo $expdtl['detail']; ?>" placeholder="Detail">
    </div>
    </div>
    <div class="form-group">
